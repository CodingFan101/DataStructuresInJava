 ...
 * 
 *         Extra methods added for lab exercise by Charles Hoot //- * @version
 *         5.1
 * 
 */
public final class ArrayBag<T> implements BagInterface<T> {
	...
	/**
	 * Override the toString() method so that we get a more useful display of the
	 * contents in the bag.
	 * 
	...
	public boolean equals(ArrayBag<T> aBag) {
		...
		for (int i = 0; i < numberOfEntries; i++) {
			...
			if (getFrequencyOf(element) != aBag.getFrequencyOf(element)) {
				return false;
			}
