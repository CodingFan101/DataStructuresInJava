 ...
 * 
 * This code is from Chapter 12 of Data Structures and Abstractions with Java
 * 5/e
 * 
 * @author Frank M. Carrano
 * @author Timothy M. Henry
 * 
 *         Modifications were made by Charles Hoot: The toString method is
 *         overwritten to give a nice display of the items in the list in this
 *         format { <1> <2> <3> <4> }
 * 
 *         An alternate display method has been created to print the list one
 *         item to a line along with the index
 * 
...
class LList<T> implements ListInterface<T> {
    ...
    /**
     * Display the list with indices one to a line This will correctly display an
     * infinite list, whereas the toString() method will never return.
     * 
     */
    public void display() {
        int index = 1;
    ...
    public void cycle() {
    	...
    	if(numberOfEntries > 1) {
    		...
    		initial.setNextNode(null);
    		
    		Node begin = firstNode;
    		while(begin.next != null) {
    			begin = begin.next;
    		}
    		begin.setNextNode(initial);
    	}
    }
}
