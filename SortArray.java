...
public class SortArray {
	 ...
	 * 
	 * @param a     An array of Comparable objects.
	 * @param first An integer >= 0 that is the index of the first array element to
	 *              consider.
	...
	/** Avoids even spacing */
	public static <T extends Comparable<? super T>> void betterShellSort(T[] a, int n) {
		betterShellSort(a, 0, n - 1);
	} // end betterShellSort

	public static <T extends Comparable<? super T>> void betterShellSort(T[] a, int first, int last) {
	...
	public static <T extends Comparable<? super T>> void betterBubbleSort(T[] a, int n) {
		// TODO: implement better bubble sort
		int length = n;
		for (int i = 0; i <= length - 1; i++) {
